...
CounterUI::CounterUI(IJAttempter &attempter, QWidget *parent)
...
// 启/停用界面控制按钮
void CounterUI::enableOptionButton(bool enable)
{
    if (q_btnConfirm) {
