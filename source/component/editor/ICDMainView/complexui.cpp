...
ComplexUI::ComplexUI(IJAttempter &attempter, QWidget *parent)
...
// 启/停用界面控制按钮
void ComplexUI::enableOptionButton(bool enable)
{
    if (q_btnConfirm) {
