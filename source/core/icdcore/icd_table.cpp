...
public:
    ...
    qint64 currentMillisecond() const;
...
void TableData::saveItem(const ItemPtr &item)
{
    ...
    case Icd::ItemHead:
    {
        ...
        headers.push_back(headerItem->defaultValue());
        break;
    }
...
qint64 TableData::currentMillisecond() const
{
#if 1
...
void Table::insertItem(int index, const ItemPtr &item)
{
    ...
    int bufferOffset = (*citer)->bufferOffset();
