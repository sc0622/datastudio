...
double NumericItem::orignalData() const
{
    ...
    case NumericInt64: value = *(icd_int64 *)buffer; break;
    case NumericUint64: value = *(icd_uint64 *)buffer; break;
...
std::pair<double, double> NumericItem::dataRange() const
{
    ...
    if (d->limit->rightInf()) {
        ...
        case NumericUint32:
        case NumericUint64:
            range.second = (0x1i64 << typeSize) - 1;
            break;
        case NumericInt8:
        case NumericInt16:
        case NumericInt32:
        case NumericFloat32:
        case NumericFloat64:
            range.second = (0x1i64 << (typeSize - 1)) - 1;
            break;
        default:
            break;
        }
