    ...
    , d_bindTableTypes(bindingTypes)
{
    ...
    d_buttonRun = new QPushButton(QStringLiteral(""), this);
...
Icd::Parser *CoreTreeWidgetPrivate::parser() const
{
    return d_parser;
}

void CoreTreeWidgetPrivate::setParser(Icd::Parser *parser)
{
    d_parser = parser;
}
...
bool CoreTreeWidgetPrivate::loadData()
{
    ...
    clearData();
    //
    JTreeViewItem *itemRoot = new JTreeViewItem(QStringLiteral("ICD数据"),
...
void CoreTreeWidgetPrivate::exportBindingStatus(const QString &filePath)
{
    ...
    procAllTableItem(invisibleRootItem(),  true,
                     [=,&emRoot](QStandardItem *item, const QString &channelId){
